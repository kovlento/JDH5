<template lang="html">
    <Panel title="尖货推荐" :class="$style.panel">
        <section :class="$style.content">
            <div :class="$style.item" v-for="item in items" :key="item.catory">
                <img :src="item.catory" alt="">
                <section :class="$style.list">
                    <div :class="$style.product" v-for="list in item.list" :key="list.title">
                        <img :src="list.img" alt="">
                        <p :class="$style.title">{{ list.title }}</p>
                        <p :class="$style.price"> <em>{{ list.price }}</em> 起 </p>
                        <article>
                            <div :class="$style.wrapper">
                                <div :class="$style.inner" :style="{width:list.progress+'%'}"/>
                            </div>
                            <p>{{ list.progress }}%</p>
                        </article>
                        <label v-if="list.label">精选</label>
                    </div>
